...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findByPriceLessThanOrPriceGreaterThan(float lowerBound, float upperBound) {
    ...
    @Override
    public List<Book> findByReleaseDateYearNot(int releaseYear) {

        return bookRepository.findByReleaseDateYearNot(releaseYear);
    }

    @Override
    public List<Book> findByReleaseDateBefore(String input) {
    ...
    @Override
    public List<String> findByTitleContaining(String containedString) {
        return bookRepository.findByTitleContaining(containedString)
                .stream()
                .map(Book::getTitle)
                .collect(Collectors.toList());
    }
    ...
    @Override
    public int deleteWithCopiesLessThanAmount(int amount) {
