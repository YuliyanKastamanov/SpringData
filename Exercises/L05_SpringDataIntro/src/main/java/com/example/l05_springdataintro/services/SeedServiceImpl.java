...
import com.example.l05_springdataintro.entities.*;
import com.example.l05_springdataintro.repositories.*;
...
public class SeedServiceImpl implements SeedService{
    ...
    private Book getBookObject(String line) {
        ...
        return new Book(title, editionType, price, copies, publishedDate,
